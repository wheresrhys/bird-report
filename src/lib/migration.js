import {group, sortPropAsc, sortPropDesc} from './data-tools'
 ...
 * @returns {number}
 */
export const earliestFirst = (a, b) => memoizedEarliestFirst(a, b);
 ...
 * @returns {number}
 */
export const latestFirst = (a, b) => -1 * earliestFirst(a, b);
